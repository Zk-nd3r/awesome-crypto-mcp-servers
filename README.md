...
- **[Frontier-Compute/zcash-mcp](https://github.com/Frontier-Compute/zcash-mcp)** - MCP server for Zcash with 22 tools - shielded transactions, attestation verification, wallet management.
